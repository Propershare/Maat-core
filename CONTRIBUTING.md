...
If you use an agent, run it from the **maat-core** repository root so it picks up `AGENTS.md` automatically. Your agent must follow the rules and guidelines in that file.
