# @propershare/maat-agent-core

Stateful agent with tool execution and event streaming. Built on `@propershare/maat-ai`.

## Installation

```bash
npm install @propershare/maat-agent-core
```
...
```typescript
import { Agent, streamProxy } from "@propershare/maat-agent-core";
...
```typescript
import { agentLoop, agentLoopContinue } from "@propershare/maat-agent-core";
