...
```typescript
import type { ExtensionAPI } from "@propershare/maat-coding-agent";
...
| Package | Purpose |
|---------|---------|
| `@propershare/maat-coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `@sinclair/typebox` | Schema definitions for tool parameters |
| `@propershare/maat-ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@propershare/maat-tui` | TUI components for custom rendering |
...
```typescript
import { isToolCallEventType } from "@propershare/maat-coding-agent";
...
```typescript
import { isBashToolResult } from "@propershare/maat-coding-agent";
...
```typescript
import { createLocalBashOperations } from "@propershare/maat-coding-agent";
...
```typescript
import { SessionManager } from "@propershare/maat-coding-agent";
...
```typescript
import { Type } from "@sinclair/typebox";
import { StringEnum } from "@propershare/maat-ai";
...
```typescript
import type { AutocompleteItem } from "@propershare/maat-tui";
...
```typescript
import { withFileMutationQueue } from "@propershare/maat-coding-agent";
...
import { Type } from "@sinclair/typebox";
import { StringEnum } from "@propershare/maat-ai";
import { Text } from "@propershare/maat-tui";
...
**Important:** Use `StringEnum` from `@propershare/maat-ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
- [read.ts](https://github.com/Propershare/Maat-runtime/blob/main/packages/coding-agent/src/core/tools/read.ts) - `ReadToolDetails`
- [bash.ts](https://github.com/Propershare/Maat-runtime/blob/main/packages/coding-agent/src/core/tools/bash.ts) - `BashToolDetails`
- [edit.ts](https://github.com/Propershare/Maat-runtime/blob/main/packages/coding-agent/src/core/tools/edit.ts)
- [write.ts](https://github.com/Propershare/Maat-runtime/blob/main/packages/coding-agent/src/core/tools/write.ts)
- [grep.ts](https://github.com/Propershare/Maat-runtime/blob/main/packages/coding-agent/src/core/tools/grep.ts) - `GrepToolDetails`
- [find.ts](https://github.com/Propershare/Maat-runtime/blob/main/packages/coding-agent/src/core/tools/find.ts) - `FindToolDetails`
- [ls.ts](https://github.com/Propershare/Maat-runtime/blob/main/packages/coding-agent/src/core/tools/ls.ts) - `LsToolDetails`
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@propershare/maat-coding-agent";
...
```typescript
import { createBashTool } from "@propershare/maat-coding-agent";
...
} from "@propershare/maat-coding-agent";
...
Tools can provide `renderCall` and `renderResult` for custom TUI display. See [tui.md](tui.md) for the full component API and [tool-execution.ts](https://github.com/Propershare/Maat-runtime/blob/main/packages/coding-agent/src/modes/interactive/components/tool-execution.ts) for how tool rows are composed.
...
```typescript
import { keyHint } from "@propershare/maat-coding-agent";
...
```typescript
import { Text, Component } from "@propershare/maat-tui";
...
```typescript
import { CustomEditor, type ExtensionAPI } from "@propershare/maat-coding-agent";
import { matchesKey } from "@propershare/maat-tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@propershare/maat-coding-agent";
