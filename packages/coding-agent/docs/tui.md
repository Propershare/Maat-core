...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@propershare/maat-tui";
...
```typescript
import { Container, type Focusable, Input } from "@propershare/maat-tui";
...
Import from `@propershare/maat-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@propershare/maat-tui";
```
...
```typescript
import { matchesKey, Key } from "@propershare/maat-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@propershare/maat-tui";
...
```typescript
import { getMarkdownTheme } from "@propershare/maat-coding-agent";
import { Markdown } from "@propershare/maat-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@propershare/maat-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@propershare/maat-coding-agent";
import { DynamicBorder } from "@propershare/maat-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@propershare/maat-tui";
...
```typescript
import { BorderedLoader } from "@propershare/maat-coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@propershare/maat-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@propershare/maat-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@propershare/maat-tui";
...
import { matchesKey, truncateToWidth } from "@propershare/maat-tui";
