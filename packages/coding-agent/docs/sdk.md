...
```bash
npm install @propershare/maat-coding-agent
```
...
```typescript
import { createAgentSession } from "@propershare/maat-coding-agent";
...
The `Agent` class (from `@propershare/maat-agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
import { AuthStorage, ModelRegistry } from "@propershare/maat-coding-agent";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@propershare/maat-coding-agent";
...
import { createAgentSession, defineTool } from "@propershare/maat-coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@propershare/maat-coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@propershare/maat-coding-agent";
