...
```bash
npm install @propershare/maat-ai
```

TypeBox exports are re-exported from `@propershare/maat-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@propershare/maat-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@propershare/maat-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@propershare/maat-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@propershare/maat-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@propershare/maat-ai';
...
```typescript
import { getModel, stream } from '@propershare/maat-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@propershare/maat-ai';
...
```typescript
import { Model, stream } from '@propershare/maat-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@propershare/maat-ai';
...
```typescript
import { getModel, complete, Context } from '@propershare/maat-ai';
...
```typescript
import { Context, getModel, complete } from '@propershare/maat-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@propershare/maat-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@propershare/maat-ai';
...
```bash
npx @propershare/maat-ai login              # interactive provider selection
npx @propershare/maat-ai login anthropic    # login to specific provider
npx @propershare/maat-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@propershare/maat-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@propershare/maat-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@propershare/maat-ai/oauth';
...
```typescript
import { getModel, complete } from '@propershare/maat-ai';
import { getOAuthApiKey } from '@propershare/maat-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@propershare/maat-ai`
