# @propershare/maat-web-ui

Reusable web UI components for building AI chat interfaces powered by [@propershare/maat-ai](../ai) and [@propershare/maat-agent-core](../agent).
...
```bash
npm install @propershare/maat-web-ui @propershare/maat-agent-core @propershare/maat-ai
```
...
```typescript
import { Agent } from '@propershare/maat-agent-core';
import { getModel } from '@propershare/maat-ai';
import {
  ChatPanel,
  AppStorage,
  ...
  defaultConvertToLlm,
  ApiKeyPromptDialog,
} from '@propershare/maat-web-ui';
import '@propershare/maat-web-ui/app.css';
...
declare module '@propershare/maat-agent-core' {
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@propershare/maat-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@propershare/maat-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@propershare/maat-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@propershare/maat-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@propershare/maat-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@propershare/maat-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@propershare/maat-web-ui';
...
```typescript
import { SessionListDialog } from '@propershare/maat-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@propershare/maat-web-ui';
...
```typescript
import { ModelSelector } from '@propershare/maat-web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@propershare/maat-web-ui';
